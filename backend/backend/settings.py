...
SECRET_KEY = "django-insecure-)*zb61zu&*&)w)usi-v60jqa6)p85hzst%zo11o9es44)@d%ap"
...
default_dbur1 = "sqlite:///" + str(BASE_DIR / "db.sqlite3")

DATABASES = {
    "default": config("DATABASE_URL", default=default_dbur1, cast=dburl)
}
